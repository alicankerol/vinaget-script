...
class dl_rapidgator_net extends Download {
	...
	public function CheckAcc($cookie){
		...
		elseif(stristr($data, 'Premium till')) {
			...
			else return array(true, "Until ".$this->lib->cut_str($data, 'Premium till','<span')." <br/>Bandwidth available:" .$this->lib->cut_str($this->lib->cut_str($data, 'Bandwidth available</td>','<div style='), '<td>','</br>'));
		}
